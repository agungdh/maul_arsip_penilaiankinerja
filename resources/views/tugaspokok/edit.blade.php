	...
	<div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header with-border">
				<h3 class="box-title">Ubah Detail Template Tugas Pokok</h3>
			</div>

			{!! Form::model($detailtemplatetugaspokok, ['route' => ['detailtemplatetugaspokok.update', $detailtemplatetugaspokok->id], 'role' => 'form', 'method' => 'put']) !!}
